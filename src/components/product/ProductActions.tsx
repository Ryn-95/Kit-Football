...
const flocageSuggestionsByKey: Record<string, string[]> = {
  ...
  "argentine": ["MESSI", "DI MARIA", "ALVAREZ", "FERNANDEZ", "MAC ALLISTER", "MARTINEZ"],
  "brazil": ["VINICIUS JR", "RODRYGO", "NEYMAR JR", "RICHARLISON", "PAQUETA", "MARQUINHOS"],
  "bresil": ["VINICIUS JR", "RODRYGO", "NEYMAR JR", "RICHARLISON", "PAQUETA", "MARQUINHOS"],
  "spain": ["MORATA", "PEDRI", "GAVI", "YAMAL", "RODRI", "WILLIAMS"],
  "espagne": ["MORATA", "PEDRI", "GAVI", "YAMAL", "RODRI", "WILLIAMS"],
  "england": ["KANE", "BELLINGHAM", "SAKA", "FODEN", "RICE", "GREALISH"],
  "angleterre": ["KANE", "BELLINGHAM", "SAKA", "FODEN", "RICE", "GREALISH"],
  "germany": ["MUSIALA", "WIRTZ", "KROOS", "GUNDOGAN", "HAVERTZ", "FULLKRUG"],
  "allemagne": ["MUSIALA", "WIRTZ", "KROOS", "GUNDOGAN", "HAVERTZ", "FULLKRUG"],
  "italy": ["CHIESA", "BARELLA", "DONNARUMMA", "DIMARCO", "PELLEGRINI"],
  "italie": ["CHIESA", "BARELLA", "DONNARUMMA", "DIMARCO", "PELLEGRINI"],
  "belgium": ["DE BRUYNE", "LUKAKU", "DOKU", "TROSSARD", "ONANA"],
  "belgique": ["DE BRUYNE", "LUKAKU", "DOKU", "TROSSARD", "ONANA"],
  "netherlands": ["GAKPO", "SIMONS", "VAN DIJK", "DE LIGT", "DUMFRIES"],
  "pays-bas": ["GAKPO", "SIMONS", "VAN DIJK", "DE LIGT", "DUMFRIES"],
  "algerie": ["MAHREZ", "BENNACER", "AOUAR", "BENSEBAINI", "FEGHOULI"],
  "maroc": ["HAKIMI", "ZIYECH", "AMRABAT", "OUNAHI", "BONO"],
  "senegal": ["MANE", "KOULIBALY", "SARR", "MENDY", "GUEYE"],
  "cote-ivoire": ["HALLER", "PEPE", "KESSIE", "AURIER", "SANGARE"],
};
