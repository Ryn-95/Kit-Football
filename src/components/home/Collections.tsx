import { PREMIUM_COLLECTIONS } from "../../data/mock";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
          {PREMIUM_COLLECTIONS.map((collection, index) => {
            const gradients = [
              ...
              "from-[#111111] to-[#1a1a1a]"  
            ];
            const shortNames = ["PSG", "REAL", "CITY", "BARÇA"];
            ...
            return (
              ...
              >
                ...
                <Image 
                  ...
                  fill
                  className="object-cover object-top opacity-50 group-hover:opacity-70 group-hover:scale-105 transition-all duration-700 mix-blend-luminosity grayscale group-hover:grayscale-0"
                />
                ...
                <div className="relative z-20 flex flex-col items-center w-full translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                  <h3 className="font-heading font-black text-5xl md:text-6xl text-white italic uppercase tracking-tighter drop-shadow-2xl mb-4 group-hover:text-[var(--color-brand-volt)] transition-colors">
                    {shortNames[index] || collection.title}
                  </h3>
